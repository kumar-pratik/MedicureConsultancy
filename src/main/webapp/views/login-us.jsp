...
<div class="fixed-header">
        <div class="container">
            ...
            <img src="<c:url value="/resources/static/images/logo-edited.png"/>"  style="margin-left:-18px"/>
               ...
               <a href="../patient/signup" class="w3-button w3-white w3-padding-large w3-large w3-margin-top" style="color:black;padding: 8px 10px!important;margin-top: 0px!important;margin-left: 97px;">SignUp</a>
               <a href="../login" class="w3-button w3-white w3-padding-large w3-large w3-margin-top" style="color:black;padding: 8px 10px!important;margin-top: 0px!important;margin-left: 8px;">Login</a>
...
<div id="form_wrapper">
        ...
        <form:form action="loginUs" method="post" modelAttribute="user">
        <div id="form_right">
            <h1>Login</h1>
            ...
            <center><input type="submit" value="Login" id='input_submit' class='input_field' style="width:40%" onclick="myalert()"></center>
