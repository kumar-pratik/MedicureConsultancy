...
<div class="w3-container"  id="team"><br>
  <h3 class="w3-center">PATIENT APPOINTMENT DETAILS</h3>
  <br>
  ...
  <div class="w3-col l3 m6 w3-margin-bottom" style="width:70%;height:50%">
      <div class="w3-card">
        ...
        <c:choose>
          ...
          <c:otherwise>
          <textarea name="prescription" rows="6" cols="100" value="" placeholder="Enter prescription" disabled>${pres.prescription}</textarea>
          </c:otherwise>
          </c:choose>
