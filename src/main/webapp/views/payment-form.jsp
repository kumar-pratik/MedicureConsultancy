...
<div class="row">
  <div class="col-75">
    <div class="container1">
      <form action="paymentGateway" method="post" modelAttribute="payForm">
...
<input type="text" name="patientId" value=${patient.patientId}>
        ...
        <div class="row">
          ...
          <div class="col-50">
            ...
            <input type="text" id="ccnum"  placeholder="Enter 16 digit card number" required>
            <label for="expmonth">Exp Month</label>
            <input type="text" id="expmonth" placeholder="Enter expiry month" required>
            <div class="row" style="margin: 0px 0px;">
              <div class="col-50">
                <label for="expyear">Exp Year</label>
                <input type="text" id="expyear"  placeholder="Enter expiry year" required>
              </div>
              <div class="col-50">
                <label for="cvv">CVV</label>
                <input type="text" id="cvv"  placeholder="Enter 3 digit CVV number" required>
              </div>
            </div>
          </div>
  ...
  <div class="col-25">
    <div class="container1">
      ...
      <p><a href="#">Appointment</a> <span class="price">Rs. 700</span></p>

      <hr>
      <p>Total <span class="price" style="color:black"><b>Rs. 700</b></span></p>
    </div>
  </div>
</div>
