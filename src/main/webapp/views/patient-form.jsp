...
method="post" modelAttribute="patient" onsubmit="return validate()">
        ...
        <div id="form_right" style="margin-top: -43px;">
            ...
            <center><div class="input_container">
                ...
                <input  placeholder="Name" type="text" name="name" id="field_password" class='input_field' required/>
            </div></center>
            <center><div class="input_container">
             ...
             <center><div class="input_container">
                ...
                <input placeholder="Phone Number" type="text"  name="phoneNum" id="field_password" class='input_field'  required/>
            </div></center>
             ...
             <center><div class="input_container">
               ...
               <select  placeholder="Gender" tye="text" id="gender" name="gender" class='input_field'  required/>
            ...
            <option value="Female">Female</option>
              ...
              <center><div class="input_container">
                ...
                <input  placeholder="Date of Birth" type="date" name="dob" id="dob" class='input_field'  required/>
            </div></center>
            
               <center><div class="input_container">
                <i class="	fas fa-burn"></i>
               <select  placeholder="Blood Group" tye="text" id="bloodGroup" name="bloodGroup" class='input_field' required/>
