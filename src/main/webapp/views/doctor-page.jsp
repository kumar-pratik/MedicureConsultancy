...
<div class="w3-content" style="max-width:1100px">
  ...
  <div class="w3-row w3-padding-64" id="about">
    ...
    <div class="w3-col m6 w3-padding-large">
      ...
      <h5 class="w3-center">Dentist</h5>
      <p class="w3-large">Dr. Satyendra Singh is one of the best dentist in the area and has 9 years of experience.</p>
  ...
  <div class="w3-row w3-padding-64" id="menu">
    <div class="w3-col l6 w3-padding-large">
     ...
     <h5 class="w3-center">Pediatrician</h5>
      <p class="w3-large">Dr. Pratik Mishra is a is a Pediatrician and has a professional experience of 5 years. </p>
 ...
 <a href="../login" class="w3-button w3-light-grey w3-block">Book Appointment</a>
  ...
  <div class="w3-row w3-padding-64" id="about">
    ...
    <div class="w3-col m6 w3-padding-large">
      ...
      <h5 class="w3-center">Gynacologist</h5>
      <p class="w3-large">Dr. Ruby Kansal is a Gynacologist and has a professional experience of 5 years.</p>
 ...
 <a href="../login" class="w3-button w3-light-grey w3-block">Book Appointment</a>
  ...
  <div class="w3-row w3-padding-64" id="menu">
    <div class="w3-col l6 w3-padding-large">
     ...
     <h5 class="w3-center">Dentist</h5>
      <p class="w3-large">Dr. Divya Agarwal is a Dentist and has a professional experience of 5 years. </p>
      <p class="w3-large w3-text-grey w3-hide-medium">He completed his MBBS from R.G. Kar Medical College, Kolkata and PGCC (Diabetes) and HYUY.</p>
