...
<div id="form_wrapper" style="height: 575px!important">

        <div id="form_left">
          <img src="<c:url value="/resources/static/images/download.png"/>"/>
        </div>
        <form:form id="bookAppointment" action="appAction" method="post" modelAttribute="appForm">
<div id="form_right" style="margin-top: -37px;">
...
<input type="text" name="prescription" value=""/></div>
            ...
            <center><div class="input_container">
                ...
                <input  placeholder="Symptoms" type="text" name="symptom" id="field_password" class='input_field'  required/>
            </div></center>
            
            <center><div class="input_container">
            <i class="fas fa-user-md"></i>
            <select class="select-style gender" id="specialist" name="specialist" tabindex="5" onkeydown="fetchDoctors()" class='input_field' required>
           ...
           <option value="Pediatrician">Pediatrician</option>
			...
			<p style="margin-left: 25px!important;">Choose 2 dates, out of these Doctor will select one date for appointment.</p>
             <center><div class="input_container">
                ...
                <input placeholder="Date 1" type="date"  name="date1"  class='input_field'  required/>
            </div></center>
             <center><div class="input_container">
                <i class="fas fa-calendar"></i>
                <input  placeholder="Date 2" type="date" name="date2"  class='input_field'  required/>
            </div></center>
...
function fetchDoctors() {
  ...
  if(x=="Dentist"){
	  ...
	  '<select class="select-style gender" id="doctorid" name="doctorid" tabindex="5">'+
      '<option value="select">Select Your Doctor</option>'+
      '<option value="5">Dr. Sunidhi Shukla</option>'+
	  '<option value="3">Dr. Ruby Kansal</option>'+
	  ...
	  '<option value="select">Select Your Doctor</option>'+
      '<option value="2">Dr. Pratik Mishra</option>'+
      '<option value="6">Dr. Aradhna Srivastava</option>'+
