...
<div id="form_wrapper" style="height: 500px!important">
        <div id="form_left">
            <img src="<c:url value="/resources/static/images/download.jpg"/>"/>
        </div>
...
method="post" modelAttribute="doctor" onsubmit="return validate()">
 <div id="form_right">
            ...
            <center><div class="input_container">
                ...
                <input   type="text" name="name" id="field_password" class='input_field' value="${doctor.name}" read-only/>
            </div></center>
            <center><div class="input_container">
                <i class="fas fa-envelope"></i>
                <input  type="email" name="email" id="field_email" class='input_field' value="${doctor.email}" read-only/>
            </div></center>
           
             <center><div class="input_container">
                <i class="fas fa-phone"></i>
                <input  type="number"  name="phoneNum" id="field_password" class='input_field' value="${doctor.phoneNum}"/>
            </div></center>
               <div style="display:none">
             <center><div class="input_container">
                <i class="fas fa-phone"></i>
                <input  type="text"  name="specialization" id="field_password" class='input_field' value="${doctor.specialization}"/>
            </div></center></div>
            <div style="display:none">
             <center><div class="input_container">
                <i class="fas fa-lock"></i>
                <input  type="password" name="password" id="field_password" class='input_field' value="${doctor.password}"/>
            <input  type="password" name="dob" id="field_password" class='input_field' value="${doctor.dob}"/>
            </div></center></div>
